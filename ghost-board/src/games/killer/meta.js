...
export const meta = {
    ...
    options: {
        mode: 'How you arm and how you kill. Standard: hit your own number with any dart to build lives up to the cap and become a killer, then a single / double / treble on an opponent\'s number takes 1 / 2 / 3 of their lives. Double Trouble: only doubles count — your double arms you, an opponent\'s double costs them one life. Treble Trouble: the same, but on trebles.',
